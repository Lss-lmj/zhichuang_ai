...
面向学校真实教学场景，主要服务计算机类学生的能力成长、课程作业改进、竞赛准备和双创项目实践，同时为教师提供课程作业学情诊断与班级观察视图，构建基于通用大模型、RAG 知识库和 LangGraph 多 Agent 工作流的学科垂类智能体应用。
...
`make smoke` 会对公网或本地 Demo 做内容断言：演示账号、学校账号会话、学生成长路径、作业报告、竞赛推荐、组队、任务复盘、知识库入库与检索、Agent 引用、教师看板、教师梯队筛选和前端入口。
...
- 学生端是默认主入口，围绕画像、作业报告、学习路径、竞赛推荐、组队和任务复盘形成成长闭环
- 教师端是 P0 教学支撑场景，直接展示作业分析报告和班级学情看板
